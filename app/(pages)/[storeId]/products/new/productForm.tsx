...
export const CreatProduct: React.FC<ProductFormProps> = ({
    categories,
    sizes,
}) => {
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        try {
            setLoading(true);
            const response = await axios.post(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/${params.storeId}/addProduct`, values);
